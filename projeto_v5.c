...
bool verificar_palavra (FILE *pont_dados, char *palavra) { //ler uma palavra de uma linha aleatória
...
int main () { 
    ...
    //verificando se tem a palavra no arquivo
    char palavraa[] = "abacaxi";
    verificar_palavra(pont_dados, palavraa);
